...
[[[$$b_{i} = {median}(a_{1},a_{2},\ldots,a_{2i - 1}).$$][[[]{.strut
...
style="margin-right: 0.2778em;"}[=]{.mrel}[]{.mspace
style="margin-right: 0.2778em;"}]{.base}[[]{.strut
style="height: 1em; vertical-align: -0.25em;"}[[median]{.mord
.mathrm}]{.mop}[]{.mspace
style="margin-right: 0.1667em;"}[[(]{.mord}]{.mord}[[a]{.mord
...
style="margin-right: 0.1667em;"}[[a]{.mord .mathnormal}[[[[[[]{.pstrut
style="height: 2.7em;"}[[[2]{.mord .mtight}[i]{.mord .mathnormal
.mtight}[−]{.mbin .mtight}[1]{.mord .mtight}]{.mord .mtight}]{.sizing
.reset-size6 .size3
.mtight}]{style="top: -2.55em; margin-left: 0em; margin-right: 0.05em;"}]{.vlist
style="height: 0.3117em;"}[​]{.vlist-s}]{.vlist-r}[[]{.vlist
style="height: 0.2083em;"}]{.vlist-r}]{.vlist-t
.vlist-t2}]{.msupsub}]{.mord}[[)]{.mord}]{.mord}[.]{.mord}]{.base}]{.katex-html
aria-hidden="true"}]]

其中，[[$median$][[[]{.strut
style="height: 0.6944em;"}[[median]{.mord
.mathrm}]{.mop}]{.base}]{.katex-html aria-hidden="true"}]
为取中位数操作，长度为 [[$2i - 1$][[[]{.strut
style="height: 0.7429em; vertical-align: -0.0833em;"}[2]{.mord}[i]{.mord
.mathnormal}[]{.mspace
style="margin-right: 0.2222em;"}[−]{.mbin}[]{.mspace
style="margin-right: 0.2222em;"}]{.base}[[]{.strut
style="height: 0.6444em;"}[1]{.mord}]{.base}]{.katex-html
aria-hidden="true"}] 的序列的中位数是将其从小到大排序后的第
[[$i$][[[]{.strut style="height: 0.6595em;"}[i]{.mord
.mathnormal}]{.base}]{.katex-html aria-hidden="true"}] 个元素。

将序列 [[$a$][[[]{.strut
style="height: 0.4306em;"}[a]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}] 和序列 [[$b$][[[]{.strut
style="height: 0.6944em;"}[b]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}]
拼接，再将得到的序列**任意打乱**，得到一个长度为：

[[[$$n + m = \frac{3n + 1}{2}$$][[[]{.strut
...
style="height: 3em;"}[]{.frac-line
style="border-bottom-width: 0.04em;"}]{style="top: -3.23em;"}[[]{.pstrut
style="height: 3em;"}[[3]{.mord}[n]{.mord .mathnormal}[]{.mspace
style="margin-right: 0.2222em;"}[+]{.mbin}[]{.mspace
style="margin-right: 0.2222em;"}[1]{.mord}]{.mord}]{style="top: -3.677em;"}]{.vlist
style="height: 1.3214em;"}[​]{.vlist-s}]{.vlist-r}[[]{.vlist
style="height: 0.686em;"}]{.vlist-r}]{.vlist-t
...
现在给定 [[$n$][[[]{.strut
style="height: 0.4306em;"}[n]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}] 和打乱后的序列
[[$c$][[[]{.strut style="height: 0.4306em;"}[c]{.mord
.mathnormal}]{.base}]{.katex-html
aria-hidden="true"}]，请构造任意一个可能的排列
[[$a$][[[]{.strut style="height: 0.4306em;"}[a]{.mord
.mathnormal}]{.base}]{.katex-html
aria-hidden="true"}]。如果不存在满足条件的排列，输出 `-1`。

序列 [[$c$][[[]{.strut
style="height: 0.4306em;"}[c]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}] 中元素的顺序不包含任何额外信息。

**样例解释**

样例中，排列可以取为 [[$\lbrack 2,1,3\rbrack$][[[]{.strut
...
aria-hidden="true"}]。长度为 [[$1$][[[]{.strut
style="height: 0.6444em;"}[1]{.mord}]{.base}]{.katex-html
aria-hidden="true"}] 和 [[$3$][[[]{.strut
style="height: 0.6444em;"}[3]{.mord}]{.base}]{.katex-html
aria-hidden="true"}] 的奇数 前缀中位数均为
[[$2$][[[]{.strut
style="height: 0.6444em;"}[2]{.mord}]{.base}]{.katex-html
aria-hidden="true"}]，因此 [[$a$][[[]{.strut
style="height: 0.4306em;"}[a]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}] 与中位数序列拼接后的多重集合恰好
等于输入的多重集合。
...
- [[$1 \leq n \leq 3 \times 10^{5}$][[[]{.strut
    ...
    aria-hidden="true"}]，且 [[$n$][[[]{.strut
    style="height: 0.4306em;"}[n]{.mord
    .mathnormal}]{.base}]{.katex-html aria-hidden="true"}]
    为奇数；
- [[$1 \leq c_{i} \leq n$][[[]{.strut
    style="height: 0.7804em; vertical-align: -0.136em;"}[1]{.mord}[]{.mspace
    style="margin-right: 0.2778em;"}[≤]{.mrel}[]{.mspace
    style="margin-right: 0.2778em;"}]{.base}[[]{.strut
...
第一行包含一个奇数 [[$n$][[[]{.strut
style="height: 0.4306em;"}[n]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}]（[[$1 \leq n \leq 3 \times 10^{5}$][[[]{.strut
style="height: 0.7804em; vertical-align: -0.136em;"}[1]{.mord}[]{.mspace
style="margin-right: 0.2778em;"}[≤]{.mrel}[]{.mspace
style="margin-right: 0.2778em;"}]{.base}[[]{.strut
style="height: 0.7719em; vertical-align: -0.136em;"}[n]{.mord
...
style="height: 3em;"}[]{.frac-line
style="border-bottom-width: 0.04em;"}]{style="top: -3.23em;"}[[]{.pstrut
style="height: 3em;"}[[[3]{.mord .mtight}[n]{.mord .mathnormal
.mtight}[+]{.mbin .mtight}[1]{.mord .mtight}]{.mord .mtight}]{.sizing
...
[[$c_{1},c_{2},\ldots,c_{\frac{3n + 1}{2}}$][[[]{.strut
style="height: 0.9176em; vertical-align: -0.487em;"}[[c]{.mord
.mathnormal}[[[[[[]{.pstrut style="height: 2.7em;"}[[1]{.mord
.mtight}]{.sizing .reset-size6 .size3
.mtight}]{style="top: -2.55em; margin-left: 0em; margin-right: 0.05em;"}]{.vlist
style="height: 0.3011em;"}[​]{.vlist-s}]{.vlist-r}[[]{.vlist
...
style="margin-right: 0.1667em;"}[,]{.mpunct}[]{.mspace
style="margin-right: 0.1667em;"}[[c]{.mord .mathnormal}[[[[[[]{.pstrut
style="height: 3em;"}[[[[]{.mopen .nulldelimiter .sizing .reset-size3
.size6}[[[[[[]{.pstrut style="height: 3em;"}[[[2]{.mord .mtight}]{.mord
.mtight}]{.sizing .reset-size3 .size1
.mtight}]{style="top: -2.656em;"}[[]{.pstrut
style="height: 3em;"}[]{.frac-line .mtight
style="border-bottom-width: 0.049em;"}]{style="top: -3.2255em;"}[[]{.pstrut
style="height: 3em;"}[[[3]{.mord .mtight}[n]{.mord .mathnormal
.mtight}[+]{.mbin .mtight}[1]{.mord .mtight}]{.mord .mtight}]{.sizing
.reset-size3 .size1 .mtight}]{style="top: -3.384em;"}]{.vlist
style="height: 0.8443em;"}[​]{.vlist-s}]{.vlist-r}[[]{.vlist
style="height: 0.344em;"}]{.vlist-r}]{.vlist-t
.vlist-t2}]{.mfrac}[]{.mclose .nulldelimiter .sizing .reset-size3
.size6}]{.mord .mtight}]{.mord .mtight}]{.sizing .reset-size6 .size3
.mtight}]{style="top: -2.7538em; margin-left: 0em; margin-right: 0.05em;"}]{.vlist
style="height: 0.3448em;"}[​]{.vlist-s}]{.vlist-r}[[]{.vlist
style="height: 0.487em;"}]{.vlist-r}]{.vlist-t
.vlist-t2}]{.msupsub}]{.mord}]{.base}]{.katex-html
aria-hidden="true"}]（[[$1 \leq c_{i} \leq n$][[[]{.strut
style="height: 0.7804em; vertical-align: -0.136em;"}[1]{.mord}[]{.mspace
style="margin-right: 0.2778em;"}[≤]{.mrel}[]{.mspace
style="margin-right: 0.2778em;"}]{.base}[[]{.strut
style="height: 0.786em; vertical-align: -0.15em;"}[[c]{.mord
...
- 否则，输出一行 [[$n$][[[]{.strut
    ...
    style="height: 0.15em;"}]{.vlist-r}]{.vlist-t
    .vlist-t2}]{.msupsub}]{.mord}]{.base}]{.katex-html
    aria-hidden="true"}]，表示任意一个满足条件的排列。
