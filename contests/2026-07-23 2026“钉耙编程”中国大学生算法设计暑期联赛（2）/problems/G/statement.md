...
aria-hidden="true"}] 个节点的树，节点编号为
[[$1 \sim n$][[[]{.strut
style="height: 0.6444em;"}[1]{.mord}[]{.mspace
style="margin-right: 0.2778em;"}[∼]{.mrel}[]{.mspace
style="margin-right: 0.2778em;"}]{.base}[[]{.strut
style="height: 0.4306em;"}[n]{.mord .mathnormal}]{.base}]{.katex-html
aria-hidden="true"}]，根节点为 [[$1$][[[]{.strut
...
aria-hidden="true"}] 表示整数 [[$x,y$][[[]{.strut
style="height: 0.625em; vertical-align: -0.1944em;"}[x]{.mord
.mathnormal}[,]{.mpunct}[]{.mspace
style="margin-right: 0.1667em;"}[y]{.mord .mathnormal
style="margin-right: 0.0359em;"}]{.base}]{.katex-html
aria-hidden="true"}] 的最大公约数，记
[[${lca}(x,y)$][[[]{.strut
style="height: 1em; vertical-align: -0.25em;"}[[lca]{.mord
.mathrm}]{.mord}[(]{.mopen}[x]{.mord .mathnormal}[,]{.mpunct}[]{.mspace
style="margin-right: 0.1667em;"}[y]{.mord .mathnormal
style="margin-right: 0.0359em;"}[)]{.mclose}]{.base}]{.katex-html
aria-hidden="true"}] 表示节点 [[$x,y$][[[]{.strut
style="height: 0.625em; vertical-align: -0.1944em;"}[x]{.mord
.mathnormal}[,]{.mpunct}[]{.mspace
style="margin-right: 0.1667em;"}[y]{.mord .mathnormal
style="margin-right: 0.0359em;"}]{.base}]{.katex-html
aria-hidden="true"}]
在这棵树中的最近公共祖先的编号。河灵想知道，"数论"和"树论"碰撞在一起，会产生什么样的火花？

所以河灵想请你求出，有多少对 [[$x,y$][[[]{.strut
style="height: 0.625em; vertical-align: -0.1944em;"}[x]{.mord
.mathnormal}[,]{.mpunct}[]{.mspace
style="margin-right: 0.1667em;"}[y]{.mord .mathnormal
style="margin-right: 0.0359em;"}]{.base}]{.katex-html
